...
using static IPCA.Monogame.KeyboardManager;
    ...
    public class KeyboardManager : GameComponent
    {
        ...
        */
        ...
        public KeyboardManager(Game game) : base(game)
        {
            ...
            game.Components.Add(this);   // "self installable"
        }
        ...
        {
            KeyboardState state = Keyboard.GetState();                  // take the keyboard states
            List<Keys> pressedKeys = state.GetPressedKeys().ToList();   // take the list of keys pressed (array to list)
